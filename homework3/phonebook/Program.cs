...
namespace phonebook
{
    class Program
    {
        ...
        {
            //Phone book dictionary with 5 names and phone numbers
            //Ask the person to enter a name
            //try to find that name in the phone book
            //if you can find it print in the console
            //if you cant print an error message
